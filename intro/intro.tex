...
Una labor fundamental para que Internet funcione tal y como lo conocemos es el servicio DNS cuya labor consiste en realizar la traducción desde nombres de dominio a direcciones IP (por ejemplo \verb=uchile.cl= es el nombre de dominio para la dirección IP \verb=172.29.1.16=). Por su naturaleza, éste trabajo debe ser realizado de forma sumamente eficiente y libre de errores pues es un componente básico para satisfacer todo requerimiento de conexión. El inminente aumento de dispositivos accediendo a la red necesariamente supondrá un mayor nivel de carga de peticiones a dichos servidores, los cuales se verán proximamente enfrentados al desafío de tener que procesar varios órdenes de magnitud de información con respecto a la carga que manejan hoy.
...
Sin embargo, los resultados al evaluar el enfoque antes propuesto revelan un preocupante e insospechado panorama donde el rendimiento de los servidores DNS no escala al incorporar directamente paralelismo en el procesamiento de peticiones como se esperaría \cite{tesis:diego_dcc}. Éste fenómeno ha sido repasado por distintos grupos de investigación en el área como Facebook, Toshiba \cite{url:facebook, paper:toshiba} e incluso industrias nacionales como NIC Chile, pero sin mayor solución más que delegar dicha responsabilidad a unidades estructurales del sistema operativo (como el kernel del sistema operativo) de donde tampoco se han conseguido mayores mejoras.

La pregunta entonces es ¿Por qué el sistema de procesamiento de peticiones DNS no escala al incorporar paralelismo directamente? Una sospecha interesante propone que probablemente el sistema de procesamiento de paquetes para UDP (que es el protocolo involucrado en las peticiones DNS) podría tener imperfecciones a nivel de diseño en el sistema operativo que no garantizarían su óptimo funcionamiento en condiciones de concurrencia, sugiriendo como responsable del problema a un defecto de contención a nivel de estructuras compartidas del sistema operativo. Sin embargo, dicha hipótesis no ha sido comprobada ni desmentida.

Por otra parte, determinar la causa del problema anterior significa un tremendo desafío pues significa trabajar en niveles tan bajos como del núcleo del sistema operativo que combina diversos paradigmas, enfoques y lenguajes de programación incorporados a lo largo de su desarrollo.

La siguiente propuesta de tesis plantea justamente un estudio formal para identificar y analizar las distintas componentes involucradas en la extracción de paquetes desde un socket UDP y que justifiquen la situación expuesta, asi como también el estudio de alternativas para (de ser posible) corregir ésta situación.
