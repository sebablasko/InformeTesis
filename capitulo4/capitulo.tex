...
acá mostrar como opera en la práctica, mostrar el caso de cada esquema de distribución. y hablar de tiempos maximos y minimos.
...
\section{Comparación de rendimiento de la solución}

Primero se menciona que se compara en distintos entornos com threads y reuseport. se revisan los tiempos netos.
...
Luego hablar de la varaicion entre los tiempos mínimos, mostrar una ecuacion que explique como se calculará la variacion entre tiempos con respecto al tiempo total, y darle con el grafico. Se define a dicho valor el tiempo delta.

\begin{equation}
Tiempo Delta = \frac{\left(Tº Neto - Tº Mínimo\right)}{Tº Neto} * 100
\end{equation}
