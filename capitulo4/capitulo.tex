...
Hablar del uso de fn de hash para la distribucion selectiva de paquetes, y como ello puede amplair el uso de la solución a otros protocolos que pueden ser orientados a la conexión como TCP al resolver el problema del handshake inicial syn, ack, syn-ack
